...
})(["position:fixed;left:30px;cursor:pointer;bottom:30px;width:45px;box-shadow:0 0 10px 5px rgba(0,0,0,0.1);visibility:hidden;z-index:999;transition:0.3s ease;height:45px;&.active{visibility:visible;}background:#fff;border-radius:50%;align-items:center;display:flex;justify-content:center;&:active{box-shadow:0 0 10px 5px rgba(0,0,0,0.1),0 0px 0px 3px rgba(9,134,255,0.6);}i{color:", ";font-size:24px;}"], _types__WEBPACK_IMPORTED_MODULE_9__["FONT_COLOR"]);
...
//# sourceMappingURL=2.a77b2390e7b89a9e8e46.hot-update.js.map