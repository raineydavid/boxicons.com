...
})([".search-cont{transition:", ";&.active{background:#fff;box-shadow:0 0px 0px 3px rgba(81,158,250,0.85);.search-box{input{color:", ";}}}&.fixed{position:fixed;top:70px;left:0px;padding:5px;z-index:11;border-radius:0;right:0;max-width:none;background:#fff;border:0px;border-top:1px solid #dee3eb;border-bottom:1px solid #dee3eb;.search-box{max-width:", ";border-bottom:0px solid #ddd;input{font-size:18px;}}}&.active{}.search-box input::-ms-clear{display:none;}@media screen and (max-width:", "){margin:0px 0px;margin-bottom:0px;max-width:none;&.fixed{margin:0px;}}.search-box{position:relative;border-radius:", ";display:flex;width:100%;.close{order:1;align-self:center;padding:0px 15px;height:32px;cursor:pointer;}input{height:40px;margin-left:60px;box-shadow:none;outline:none;font-weight:600;order:1;color:#73859d;font-size:21px;width:100%;margin:0;padding:0;border-radius:2px;border:0;display:block;background:transparent;margin-left:10px;@media screen and (max-width:", "){height:40px;font-size:18px;}}i{@media screen and (max-width:", "){font-size:24px;height:24px;}order:1;align-self:center;padding:0px 5px;height:24px;font-size:24px;color:#73859d;cursor:pointer;&.bx-x{font-size:22px;padding:5px;background:#e8ecf7;;height:22px;line-height:22px;color:#73859d;border-radius:50%;cursor:pointer;&:hover{background:#cbd5e0;}}}}z-index:23;margin-bottom:25px;position:relative;display:block;padding:10px 15px;margin:0 auto;max-width:600px;background:#e8ecf7;border-radius:", ";}"], _types__WEBPACK_IMPORTED_MODULE_10__["TRANSITION"], _types__WEBPACK_IMPORTED_MODULE_10__["FONT_COLOR"], _types__WEBPACK_IMPORTED_MODULE_10__["MAX_WIDTH"], _types__WEBPACK_IMPORTED_MODULE_10__["BREAKPOINT_LG"], _types__WEBPACK_IMPORTED_MODULE_10__["BUTTON_RADIUS"], _types__WEBPACK_IMPORTED_MODULE_10__["BREAKPOINT_MD"], _types__WEBPACK_IMPORTED_MODULE_10__["BREAKPOINT_MD"], _types__WEBPACK_IMPORTED_MODULE_10__["BUTTON_RADIUS"]);
...
//# sourceMappingURL=index.js.ad7f5b56edd0612c1180.hot-update.js.map